...
## v2026.09.25-0029-rolling-rpi

- Synchronized to official VyOS Rolling `2026.09.25-0029-rolling`.
- Official upstream release: https://github.com/vyos/vyos-nightly-build/releases/tag/2026.09.25-0029-rolling
- Exact `vyos/vyos-build` commit: `d1394291337eb0274e026145a4c6245207c1c71d`.
- Verified critical userspace package parity: FRR `10.6.1-0`, Podman `5.8.4`, vyos-1x `999.0-14942-g4e3e38a2e`.
...
## v2026.09.24-0028-rolling-rpi

- Synchronized to official VyOS Rolling `2026.09.24-0028-rolling`.
- Official upstream release: https://github.com/vyos/vyos-nightly-build/releases/tag/2026.09.24-0028-rolling
- Exact `vyos/vyos-build` commit: `b744b1a0c794db4ca1a6336053389bbc02e2e6f6`.
- Verified critical userspace package parity: FRR `10.6.1-0`, Podman `5.8.4`, vyos-1x `999.0-14932-ged218c254`.
- Raspberry Pi hardware base: `rpi-armbian-edge-7.1.8-vyos-parity`.
- Raspberry Pi kernel: `7.1.8`.
- Fresh-install `.img.xz` uses the production Raspberry Pi A/B partition layout.
- Matching `update.tar.zst` is published for `add system image` local, HTTP(S), and `latest` updates.
...
## v2026.09.23-0027-rolling-rpi

- Synchronized to official VyOS Rolling `2026.09.23-0027-rolling`.
- Official upstream release: https://github.com/vyos/vyos-nightly-build/releases/tag/2026.09.23-0027-rolling
- Exact `vyos/vyos-build` commit: `b744b1a0c794db4ca1a6336053389bbc02e2e6f6`.
- Verified critical userspace package parity: FRR `10.6.1-0`, Podman `5.8.4`, vyos-1x `999.0-14932-ged218c254`.
- Raspberry Pi hardware base: `rpi-armbian-edge-7.1.8-vyos-parity`.
- Raspberry Pi kernel: `7.1.8`.
...
## v2026.09.21-0031-rolling-rpi

- Synchronized to official VyOS Rolling `2026.09.21-0031-rolling`.
- Official upstream release: https://github.com/vyos/vyos-nightly-build/releases/tag/2026.09.21-0031-rolling
- Exact `vyos/vyos-build` commit: `b5ae37645cc0630543859c4b25fb2927a91c9071`.
- Verified critical userspace package parity: FRR `10.6.1-0`, Podman `5.8.4`, vyos-1x `999.0-14926-ge559637d3`.
- Raspberry Pi hardware base: `rpi-armbian-edge-7.1.8-vyos-parity`.
- Raspberry Pi kernel: `7.1.8`.
- Fresh-install `.img.xz` uses the production Raspberry Pi A/B partition layout.
- Matching `update.tar.zst` is published for `add system image` local, HTTP(S), and `latest` updates.
...
## v2026.09.17-0028-rolling-rpi

- Synchronized to official VyOS Rolling `2026.09.17-0028-rolling`.
- Official upstream release: https://github.com/vyos/vyos-nightly-build/releases/tag/2026.09.17-0028-rolling
- Exact `vyos/vyos-build` commit: `6a17fe5cb33921b66a24cc7440d2b968730e26a6`.
- Verified critical userspace package parity: FRR `10.6.1-0`, Podman `5.8.4`, vyos-1x `999.0-14916-g7943d798d`.
- Raspberry Pi hardware base: `rpi-armbian-edge-7.1.8-vyos-parity`.
- Raspberry Pi kernel: `7.1.8`.
- Fresh-install `.img.xz` uses the production Raspberry Pi A/B partition layout.
- Matching `update.tar.zst` is published for `add system image` local, HTTP(S), and `latest` updates.
...
## v2026.09.16-0028-rolling-rpi

- Synchronized to official VyOS Rolling `2026.09.16-0028-rolling`.
- Official upstream release: https://github.com/vyos/vyos-nightly-build/releases/tag/2026.09.16-0028-rolling
- Exact `vyos/vyos-build` commit: `6a17fe5cb33921b66a24cc7440d2b968730e26a6`.
- Verified critical userspace package parity: FRR `10.6.1-0`, Podman `5.8.4`, vyos-1x `999.0-14905-g28207a306`.
- Raspberry Pi hardware base: `rpi-armbian-edge-7.1.8-vyos-parity`.
- Raspberry Pi kernel: `7.1.8`.
- Fresh-install `.img.xz` uses the production Raspberry Pi A/B partition layout.
- Matching `update.tar.zst` is published for `add system image` local, HTTP(S), and `latest` updates.
...
## v2026.09.15-0029-rolling-rpi

- Synchronized to official VyOS Rolling `2026.09.15-0029-rolling`.
- Official upstream release: https://github.com/vyos/vyos-nightly-build/releases/tag/2026.09.15-0029-rolling
- Exact `vyos/vyos-build` commit: `22dfa15927f2bd01336ab2c0154800f061b0f2e8`.
- Verified critical userspace package parity: FRR `10.6.1-0`, Podman `5.8.4`, vyos-1x `999.0-14893-g4e1793c69`.
- Raspberry Pi hardware base: `rpi-armbian-edge-7.1.8-vyos-parity`.
- Raspberry Pi kernel: `7.1.8`.
- Fresh-install `.img.xz` uses the production Raspberry Pi A/B partition layout.
- Matching `update.tar.zst` is published for `add system image` local, HTTP(S), and `latest` updates.
...
## v2026.09.09-0029-rolling-rpi

- Synchronized to official VyOS Rolling `2026.09.09-0029-rolling`.
- Official upstream release: https://github.com/vyos/vyos-nightly-build/releases/tag/2026.09.09-0029-rolling
- Exact `vyos/vyos-build` commit: `ef1ee912347e5fa65ca4b20c2de0e695c2150b60`.
- Verified critical userspace package parity: FRR `10.6.1-0`, Podman `5.8.4`, vyos-1x `999.0-14845-g438463db0`.
- Raspberry Pi hardware base: `rpi-armbian-edge-7.1.8-vyos-parity`.
- Raspberry Pi kernel: `7.1.8`.
- Fresh-install `.img.xz` uses the production Raspberry Pi A/B partition layout.
- Matching `update.tar.zst` is published for `add system image` local, HTTP(S), and `latest` updates.
...
## v2026.09.01-0034-rolling-rpi

- Synchronized to official VyOS Rolling `2026.09.01-0034-rolling`.
- Official upstream release: https://github.com/vyos/vyos-nightly-build/releases/tag/2026.09.01-0034-rolling
- Exact `vyos/vyos-build` commit: `a0e175dc96016020b1e4b40cc6a50b66ef4dcf20`.
- Verified critical userspace package parity: FRR `10.6.1-0`, Podman `5.8.4`, vyos-1x `999.0-14795-g2c269ef45`.
- Raspberry Pi hardware base: `rpi-armbian-edge-7.1.8-vyos-parity`.
- Raspberry Pi kernel: `7.1.8`.
- Fresh-install `.img.xz` uses the production Raspberry Pi A/B partition layout.
- Matching `update.tar.zst` is published for `add system image` local, HTTP(S), and `latest` updates.
...
## v2026.08.31-0032-rolling-rpi

- Synchronized to official VyOS Rolling `2026.08.31-0032-rolling`.
- Official upstream release: https://github.com/vyos/vyos-nightly-build/releases/tag/2026.08.31-0032-rolling
- Exact `vyos/vyos-build` commit: `a02be72903ac43a78b5fa0bbeaaac15e632205e7`.
- Verified critical userspace package parity: FRR `10.6.1-0`, Podman `5.8.4`, vyos-1x `999.0-14791-g89bc4d471`.
- Raspberry Pi hardware base: `rpi-armbian-edge-7.1.8-vyos-parity`.
- Raspberry Pi kernel: `7.1.8`.
- Fresh-install `.img.xz` uses the production Raspberry Pi A/B partition layout.
- Matching `update.tar.zst` is published for `add system image` local, HTTP(S), and `latest` updates.
...
## v2026.08.28-0255-rolling-rpi

- Synchronized to official VyOS Rolling `2026.08.28-0255-rolling`.
- Official upstream release: https://github.com/vyos/vyos-nightly-build/releases/tag/2026.08.28-0255-rolling
- Exact `vyos/vyos-build` commit: `14d959fbb5ce0d2bf051c236b9050be81e17c885`.
- Verified critical userspace package parity: FRR `10.6.1-0`, Podman `5.8.4`, vyos-1x `999.0-14781-gdbbec293b`.
- Raspberry Pi hardware base: `rpi-armbian-edge-7.1.8-vyos-parity`.
- Raspberry Pi kernel: `7.1.8`.
- Fresh-install `.img.xz` uses the production Raspberry Pi A/B partition layout.
- Matching `update.tar.zst` is published for `add system image` local, HTTP(S), and `latest` updates.
